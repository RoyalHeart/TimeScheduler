...
/**
 * {@code EditProfile} class provide an interface for the Administrator to edit the profile of an user 
 * 
...
public class EditProfile extends JDialog {
	...
	boolean processUpdate() {
		...
		if(RegisterValidator.isValidName(newName) && RegisterValidator.isValidEmail(newEmail) && RegisterValidator.isValidPhone(newPhone)) {
